...
export const Features = () => {
  ...
  return (
    <SectionWrapper>
      <div id="features" className="text-gray-300 custom-screen">
        <LayoutEffect
          ...
          <div className="relative mt-12">
            <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {featuresList.map((item, idx) => (
                <li
                  key={idx}
                  className="p-4 space-y-3 border border-gray-800 rounded-xl"
                  style={{
                    background:
                      "radial-gradient(157.73% 157.73% at 50% -29.9%, rgba(203, 213, 225, 0.16) 0%, rgba(203, 213, 225, 0) 100%)",
                  }}
                >
                  <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-lg text-gray-50">
                    {item.icon}
                  </div>
