    ...
    return (
        <footer className="mt-20">
            <div className="custom-screen">
                <div className="items-center justify-between py-8 mt-10 border-t border-gray-800 sm:flex">
                    <p className="text-center text-gray-400">© 2023 Mailgo Inc. All rights reserved.</p>
                    <div className="flex items-center justify-center mt-6 text-gray-500 gap-x-6 sm:mt-0">
