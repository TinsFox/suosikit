            ...
            <nav className={`pb-5 md:text-sm md:static md:block ${state ? "bg-gray-900 absolute z-20 top-0 inset-x-0 rounded-b-2xl shadow-xl md:bg-gray-900" : "hidden"}`}>
                <div className="items-center custom-screen md:flex">
                    ...
                    <div className={`flex-1 items-center mt-8 text-gray-300 md:font-medium md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                        ...
                        <div className="items-center justify-end mt-6 space-y-6 gap-x-6 md:flex md:space-y-0 md:mt-0">
                            <Link href="/login" className="block hover:text-gray-50">
                                Sign in
                            </Link>
                            <NavLink href="/pricing" className="flex items-center justify-center text-sm font-medium text-white border border-gray-500 gap-x-1 custom-btn-bg active:bg-gray-900 md:inline-flex">
                                Start now
